...
<template>
    ...
    <div class="header">
        ...
        <div class="btn-search-wrapper">
            <button class="btn" :class="{ active: activeButton === 'pending' }" @click="handleClick('pending')">Pending</button>
            <button class="btn" :class="{ active: activeButton === 'rejected' }" @click="handleClick('rejected')">Rejected</button>
            <button class="btn" :class="{ active: activeButton === 'accepted' }" @click="handleClick('accepted')">Accepted</button>
